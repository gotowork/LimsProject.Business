...
{
	/// <summary>
	/// Data access layer class for CSerie
	/// </summary>
	partial class CSerieSql : DataLayerBase 
	{
        ...
        public List<CSerie> SelectAll()
        {
            NpgsqlCommand sqlCommand = new NpgsqlCommand();
            sqlCommand.CommandText = "public.sp_serie_SelectAll";
            sqlCommand.CommandType = CommandType.StoredProcedure;
            ...
            {                
                throw new Exception("CSerie::SelectAll::Error occured.", ex);
            }
            finally
            {
                MainConnection.Close();
        ...
        /// <returns>list of CSerie</returns>
        public List<CSerie> SelectByField(string fieldName, object value)
        {

            NpgsqlCommand sqlCommand = new NpgsqlCommand();
            sqlCommand.CommandText = "public.sp_serie_SelectByField";
            sqlCommand.CommandType = CommandType.StoredProcedure;
            ...
            {
                throw new Exception("CSerie::SelectByField::Error occured.", ex);
            }
            finally
            {
        ...
        {
            NpgsqlCommand sqlCommand = new NpgsqlCommand();
            sqlCommand.CommandText = "public.sp_serie_DeleteByPrimaryKey";
            sqlCommand.CommandType = CommandType.StoredProcedure;
            ...
            {
                throw new Exception("CSerie::DeleteByKey::Error occured.", ex);
            }
            finally
            {                
                MainConnection.Close();
        ...
        {
            NpgsqlCommand sqlCommand = new NpgsqlCommand();
            sqlCommand.CommandText = "public.sp_serie_DeleteByField";
            sqlCommand.CommandType = CommandType.StoredProcedure;
            ...
            {                
                throw new Exception("CSerie::DeleteByField::Error occured.", ex);
            }
            finally
            {             
                MainConnection.Close();
